  ...
  <body x-data class="is-header-blur" x-bind="$store.global.documentBody">
   ...
   <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
          <div class="col-span-12 grid lg:col-span-4 lg:place-items-center"style="
    margin-left: -9rem;
">>
            <div>
              <ol class="steps is-vertical line-space [--size:2.75rem] [--line:.5rem]">
                ...
                <li class="step space-x-4 pb-12 before:bg-slate-200 dark:before:bg-navy-500">
                  ...
                  <div class="text-left">
                    ...
                    <h3 class="text-base font-medium text-primary dark:text-accent-light">Thermal Energy (within the facility)</h3>
                  </div>
                </li>
                <li class="step space-x-4 pb-12 before:bg-slate-200 dark:before:bg-navy-500">
                  <div class="step-header mask is-hexagon bg-slate-200 text-slate-500 dark:bg-navy-500 dark:text-navy-100">
          ...
          <div class="col-span-12 grid lg:col-span-8"style="
    width: 52rem;
    margin-left: -6rem; height: 28rem;
">
            <div class="card">
              ...
              <div class="space-y-4 p-4 sm:p-5">
                  ...
                  <div class="grid grid-cols-4 gap-4">
                    <label class="block">
                      ...
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                       placeholder="Enter HSD Consumption in Lit" type="text">
                    </label>

                    <label class="block">
                      <span>LDO consumption</span>
                      <span style="color:red;">*</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                       placeholder="Enter LDO Consumption in Lit" type="text">
                    </label>
                   
                     <label class="block">
                      <span>PNG consumption</span>
                      <span style="color:red;">*</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" 
                      placeholder="Enter PNG Consumption in Kg" type="text">
                    </label>
                    
                      <label class="block">
                      <span>CNG/CBG consumption</span>
                      <span style="color:red;">*</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" 
                      placeholder="Enter CN/CBG Consumption in Kg" type="text">
                    </label>
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <label class="block">
                      <span>Furnace oil consumption</span>
                      <span style="color:red;">*</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                       placeholder="Enter furnance oil in Lit" type="text">
                    </label>
                     ...
                     <label class="block">
                      ...
                      <span style="color:red;">*</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" 
                      placeholder="Enter Biomass in Kg" type="text">
                    </label>
                    
                      <label class="block">
                      <span>Total Energy, in GJ</span>
                      <span style="color:red;">*</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" 
                      placeholder="Enter Total Energy in Gj" type="text">
                    </label>
                    </div>
                   
                    <div class="grid grid-cols-4 gap-4">
                      <label class="block">
                      <span>Specific Thermal Energy Consumption, in GJ/ton (FY 2023-24)</span>
                      <span style="color:red;">*</span>
                      <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" 
                      placeholder="Enter Thermal Consumption, in GJ/ton" type="text">
                    </label>
                  </div>
                </div>
                <div class="flex justify-center space-x-2 pt-4">
                 ...
                 <a href="http://localhost:8080/rescorecard/views/dashboardAdmin6.jsp" class="btn space-x-2 bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">                 
                    <span>Next</span>
