        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
          <div class="col-span-12 grid lg:col-span-4 lg:place-items-center">
            <div>
              ...
              <div class="step-header mask is-hexagon bg-success text-white dark:bg-accent">
                  ...
                  <div class="text-left">
                    ...
                    <h3 class="text-base font-medium text-success dark:text-accent-light ">Confirm</h3>
                  </div>
                </li>
              </ol>
            </div>
            ...
            <div class="card">
              <div class="border-b border-slate-200 p-4 dark:border-navy-500 sm:px-5">
                <div class="flex items-center space-x-2">
                  <div class="flex h-7 w-7 items-center justify-center rounded-lg bg-primary/10 p-1 text-success dark:bg-accent-light/10 dark:text-accent-light">
...
">
                ...
                <div class="flex justify-center space-x-2 pt-4">
                 ...
                 <a href="http://localhost:8080/rescorecard/home" class="btn space-x-2 bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">                 
                    <span>Next</span>
